...
/**
 * ProxyScoped Annotation Registers the defined object.
 */
@SuppressWarnings({ "unchecked", "rawtypes" })
public final class AutoProxyProxyConnection
	extends quina.test.proxy.ProxyConnection {
	
	public static final Object __newInstance() {
		return new AutoProxyProxyConnection();
	}
	
	public final void __initialSetting(Object[] args) {
		try {
			super.setting(
				(java.util.Queue)args[0]
				,(java.sql.Connection)args[1]
			);

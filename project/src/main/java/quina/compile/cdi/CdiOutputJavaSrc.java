...
public class CdiOutputJavaSrc {
	...
	public static final void routerScoped(String outSourceDirectory,
		...
		try {
			...
			println(w, 0, "import quina.route.Router;");
			println(w, 0, "");
			println(w, 0, "/**");
			println(w, 0, " * Route Annotation Registers the configured Component group as a Router.");
			println(w, 0, " */");
			println(w, 0, "public final class " + AnnotationRoute.AUTO_READ_ROUTE_CLASS + " {");
			println(w, 1, "private " + AnnotationRoute.AUTO_READ_ROUTE_CLASS + "() {}");
			...
			println(w, 1, " */");
			println(w, 1, "public static final void " + AnnotationRoute.AUTO_READ_ROUTE_METHOD + "() throws Exception {");
	...
	public static final void serviceScoped(String outSourceDirectory,
		...
		try {
			...
			println(w, 0, "");
			println(w, 0, "import quina.Quina;");
			println(w, 0, "import quina.compile.cdi.annotation.CdiServiceManager;");
			println(w, 0, "");
			println(w, 0, "/**");
	...
	public static final void cdiReflect(String outSourceDirectory,
		...
		try {
			...
			println(w, 0, "");
			println(w, 0, "import quina.Quina;");
			println(w, 0, "import quina.compile.cdi.annotation.CdiReflectManager;");
			println(w, 0, "import quina.compile.cdi.annotation.CdiReflectElement;");
			println(w, 0, "");
			println(w, 0, "/**");
	...
	public static final void cdiHandle(String outSourceDirectory,
		...
		try {
			...
			println(w, 0, "");
			println(w, 0, "import quina.Quina;");
			println(w, 0, "import quina.compile.cdi.annotation.CdiHandleManager;");
			println(w, 0, "");
			println(w, 0, "/**");
	...
	public static final void proxyScoped(String outSourceDirectory,
		...
		try {
			...
			println(w, 0, "");
			println(w, 0, "import quina.Quina;");
			println(w, 0, "import quina.compile.cdi.annotation.proxy.ProxyScopedManager;");
			println(w, 0, "");
			println(w, 0, "/**");
			...
			for(int i = 0; i < len; i ++) {
				...
				if(isPublicClass(clazzName, params)) {
					...
					println(w, 3, "new quina.compile.cdi.annotation.proxy.QuinaProxy() {");
					...
					println(w, 5, "quina.compile.cdi.annotation.proxy.ProxySettingArgs args) {");

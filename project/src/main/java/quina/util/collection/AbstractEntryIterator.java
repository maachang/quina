...
public class AbstractEntryIterator {
	...
	private static class Entry<K, V> implements TypesEntry<K, V> {
		Object key;
		Object value;
	 ...
	 * Entry用Iteartor.
	 */
	public static class Iterator<K, V> implements java.util.Iterator<Map.Entry<K, V>> {
	 ...
	 * EntrySet.
	 */
	public static class Set<K,V> implements java.util.Set<Map.Entry<K, V>> {
		private Base<K, V> base;
		...
		public java.util.Iterator<Map.Entry<K, V>> iterator() {
			return new AbstractEntryIterator.Iterator<K, V>(base);
		}

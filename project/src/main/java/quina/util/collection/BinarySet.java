 ...
 * BinarySet.
 * 
 * BinarySearchでキー情報を管理します.
 */
public class BinarySet<K> {
	// 検索キー.
	 ...
	 */
	@SuppressWarnings("unchecked")
	public BinarySet(final int len) {
	...
	public final BinarySet<K> add(final K key, final int no) {
		if (key == null) {
			return this;
		}

...
public class BinarySearchMap<K, V> implements AbstractKeyIterator.Base<K>,
	AbstractEntryIterator.Base<K, V>,
	Map<K, V>,
	TypesKeyValue<K, V> {

	private IndexMap<K, V> list;

	/**
	 * コンストラクタ.
	 */
	public BinarySearchMap() {
		list = new IndexMap<K, V>();
	}

	/**
	 * コンストラクタ.
	 */
	public BinarySearchMap(IndexMap<K, V> list) {
		if (list == null) {
			list = new IndexMap<K, V>();
		}
		this.list = list;
	 ...
	 * コンストラクタ.
	 */
	public BinarySearchMap(final Map<K, V> v) {
		list = new IndexMap<K, V>(v);
	}

	/**
	 * コンストラクタ.
	 */
	public BinarySearchMap(final Object... args) {
		list = new IndexMap<K, V>(args);
	}

	/**
	 * IndexMapをセット.
	 */
	protected void setIndexMap(IndexMap<K, V> list) {
		this.list = list;
	}
	...
	public BinarySearchMap putAll(Object... args) {

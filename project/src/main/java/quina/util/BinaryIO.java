...
public class BinaryIO {
	 ...
	 * @return byte[] 設定された内容が返却されます.
	 */
	public static final byte[] len1_4Binary(
		byte[] tmp, int len1_4, int len) {
		switch(len1_4) {
	...
	public static final int len4SavingBinary(byte[] tmp, int len) {
		...
		if(len < 0) {
			...
			throw new QuinaException("It's too long: " + len);
		} else if(len <= 0x003f) {
			// 1byte.
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final void writeInt1(
		OutputStream out, byte[] tmp, Number v)
		throws IOException {
		// valueがnullの場合は０を設定.
		if(v == null) {
			len1Binary(tmp, 0);
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final void writeInt2(
		OutputStream out, byte[] tmp, Number v)
		throws IOException {
		// valueがnullの場合は０を設定.
		if(v == null) {
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final void writeInt3(
		OutputStream out, byte[] tmp, Number v)
		throws IOException {
		// valueがnullの場合は０を設定.
		if(v == null) {
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final void writeInt4(
		OutputStream out, byte[] tmp, Number v)
		throws IOException {
		// valueがnullの場合は０を設定.
		if(v == null) {
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final void writeFloat(
		OutputStream out, byte[] tmp, Number v)
		throws IOException {
		// valueがnullの場合は０を設定.
		if(v == null) {
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final void writeDouble(
		OutputStream out, byte[] tmp, Number v)
		throws IOException {
		// valueがnullの場合は０を設定.
		if(v == null) {
	...
	public static final void writeString(
		OutputStream out, byte[] tmp, String v)
		throws IOException {
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final void writeDate(
		OutputStream out, byte[] tmp, Date v)
		throws IOException {
		// valueがnullの場合は０を設定.
		if(v == null) {
			len8Binary(tmp, 0L);
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final void readBinary(
		byte[] out, InputStream in, int len)
		throws IOException {
		final int rLen = in.read(out, 0, len);
		if(len != rLen) {
			throw new QuinaException(
				"Failed to read Rim information(" +
				len + " / " + rLen + ")");
		}
	}
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final int readInt1(
		InputStream in, byte[] tmp)
		throws IOException {
		readBinary(tmp, in, 1);
		return bin1Int(tmp);
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final int readInt2(
		InputStream in, byte[] tmp)
		throws IOException {
		readBinary(tmp, in, 2);
		return bin2Int(tmp);
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final int readInt3(
		InputStream in, byte[] tmp)
		throws IOException {
		readBinary(tmp, in, 3);
		return bin3Int(tmp);
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final int readInt4(
		InputStream in, byte[] tmp)
		throws IOException {
		readBinary(tmp, in, 4);
		return bin4Int(tmp);
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final int readBin1_4Int(
		InputStream in, byte[] tmp, int byte1_4Len)
		throws IOException {
	 ...
	 * @throws IOException I/O例外.
	 */
	public static final int readSavingInt(
		InputStream in, byte[] tmp)
		throws IOException {
		readBinary(tmp, in, 1);

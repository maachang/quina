...
public class HttpClient {
	 ...
	 *               Headerオブジェクトを設定した場合はHttpHeaderが設定されます.
	 *               Paramsオブジェクトを設定した場合は送信パラメータを設定します.
	 * @return HttpResult 返却データが返されます.
	 */
	@SuppressWarnings("unchecked")
	public static final HttpResult get(String url, Object... option) {
		return connect(Method.GET, url, option);
	}
	 ...
	 *               Headerオブジェクトを設定した場合はHttpHeaderが設定されます.
	 *               Paramsオブジェクトを設定した場合は送信パラメータを設定します.
	 *               NioSendDataオブジェクトを設定した場合は、その内容で送信します.
	 * @return HttpResult 返却データが返されます.
	 */
	@SuppressWarnings("unchecked")
	public static final HttpResult post(String url, Object... option) {
		return connect(Method.POST, url, option);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static final HttpResult json(String url, Map<String, Object> params, Object... option) {
		return connect(Method.POST, url, option);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static final HttpResult delete(String url, Object... option) {
		return connect(Method.DELETE, url, option);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static final HttpResult put(String url, Object... option) {
		return connect(Method.PUT, url, option);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static final HttpResult patch(String url, Object... option) {
		return connect(Method.PATCH, url, option);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static final HttpResult connect(Method method, String url, Object... option) {
		Header header = null;
